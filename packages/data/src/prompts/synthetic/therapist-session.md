---
name: synthetic-therapist-session
description: Generate synthetic therapist session descriptions for testing DAP note generation
version: "1.0.0"
variables:
  - scenarioType
  - therapeuticModality
...
Therapeutic Approach: {{therapeuticModality}}
